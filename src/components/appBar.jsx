...
function AppBar() {
    ...
    return (
        <div className='app-bar'>
            <Link onClick={() => window.reload()} className='app-name' to={"/"} >BAMOGO Clément</Link>
            ...
            <div className='contact'>
                <Link onClick={() => window.reload()} to={"https://www.linkedin.com/in/cl%C3%A9ment-bamogo-11ab71228/"} target="_blank">
                ...
                <Link onClick={() => window.reload()} className="link" to={"https://github.com/gitClems"} target="_blank">
