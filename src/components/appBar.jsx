...
function AppBar() {
    ...
    return (
        <div className='app-bar'>
            <Link onClick={this.forceUpdate}  className='app-name' to={"/"} >BAMOGO Clément</Link>
            ...
            <div className='contact'>
                <Link onClick={this.forceUpdate}  to={"https://www.linkedin.com/in/cl%C3%A9ment-bamogo-11ab71228/"} target="_blank">
                ...
                <Link onClick={this.forceUpdate}  className="link" to={"https://github.com/gitClems"} target="_blank">
